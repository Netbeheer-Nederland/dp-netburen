...
| xref::class/NetburenDataSet.adoc[`NetburenDataSet`] | xref::class/NetburenDataSet.adoc#operational_limit_sets[`operational_limit_sets`]



| xref::class/OperationalLimit.adoc[`OperationalLimit`] | xref::class/OperationalLimit.adoc#operational_limit_set[`operational_limit_set`]
