...
| xref::class/NetburenDataSet.adoc[`NetburenDataSet`] | xref::class/NetburenDataSet.adoc#usage_point_locations[`usage_point_locations`]



| xref::class/UsagePoint.adoc[`UsagePoint`] | xref::class/UsagePoint.adoc#usage_point_location[`usage_point_location`]
