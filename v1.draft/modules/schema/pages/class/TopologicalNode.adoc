...
TopologicalNode -> Bay: connectivity_node_container
...
| <<connectivity_node_container,`connectivity_node_container`>>
//| [[slots_table.connectivity_node_container]]<<connectivity_node_container,`connectivity_node_container`>>
| 0..1 +
xref::class/Bay.adoc[`Bay`]
| +++The connectivity node container to which the topological node belongs. Used to (optionally) associate the TopologicalNode with a Bay.+++
| _n/a_
...
[.text-left]
--
<<slots_table.connectivity_node_container,&#10548;>>
--
////
...
| xref::class/NetburenDataSet.adoc[`NetburenDataSet`] | xref::class/NetburenDataSet.adoc#topological_nodes[`topological_nodes`]
