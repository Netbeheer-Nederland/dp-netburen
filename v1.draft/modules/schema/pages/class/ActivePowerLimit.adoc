...
//| [[slots_table.normal_value]]<<normal_value,`normal_value`>>
| 1 +
...
| xref::class/NetburenDataSet.adoc[`NetburenDataSet`] | xref::class/NetburenDataSet.adoc#active_power_limits[`active_power_limits`]
